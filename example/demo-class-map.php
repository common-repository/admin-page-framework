...
return array(
    ...
    "APF_Demo_BuiltinFieldTypes_Table" => AdminPageFrameworkLoader_Registry::$sDirPath . "/example/admin_page/builtin_field_type/table/APF_Demo_BuiltinFieldTypes_Table.php", 
    "APF_Demo_BuiltinFieldTypes_Table_Table" => AdminPageFrameworkLoader_Registry::$sDirPath . "/example/admin_page/builtin_field_type/table/APF_Demo_BuiltinFieldTypes_Table_Table.php", 
    ...
    "APF_Demo_CustomFieldType_Path2" => AdminPageFrameworkLoader_Registry::$sDirPath . "/example/admin_page/custom_field_type/APF_Demo_CustomFieldType_Path2.php", 
    ...
    "PathCustomFieldType_Node" => AdminPageFrameworkLoader_Registry::$sDirPath . "/example/library/path-custom-field-type/PathCustomFieldType_Node.php", 
    ...
    "APF_NetworkAdmin_Tests" => AdminPageFrameworkLoader_Registry::$sDirPath . "/example/network_admin/APF_NetworkAdmin_Tests.php", 
